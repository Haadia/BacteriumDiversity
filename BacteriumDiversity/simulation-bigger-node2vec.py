   ...
   #     df.reset_index(drop=True, inplace=True)
        ...
        for index, row in features.iterrows():
           ...
           # print(df_node_features[1][18])
            FEATURES2.loc[index] = [row[1], row[2], row[3], row[4], row[5], row[6], row[7]]
...
#    print(classes)
    ...
    gcn = GCN(
        layer_sizes=[700,700,700,700,700,700,700,700,700,700], activations=["relu", "relu", "relu","relu", "relu", "relu", "relu", "relu","relu", "relu"], generator=generator, dropout=0.5
    )
...
#        callbacks=[es_callback],
    ...
    # confusion_matrix = sklearn.metrics.confusion_matrix(test_classes.columns[0], np.rint(node_predictions))
    # confusion = sklearn.metrics.multilabel_confusion_matrix(test_classes.columns[0], np.rint(node_predictions),
    #                                                         labels=["0", "1", "2"])
...
def gcnWithDeepGraph(G, classes):
    ...
    def make_gcn_model():
        ...
        return GCN(
            layer_sizes=[700, 700, 700, 700, 700, 700, 700, 700, 700, 700],
